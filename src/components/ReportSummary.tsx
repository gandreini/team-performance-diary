...
export function ReportSummary({
    ...
    if (fetching) {
        return (
            <div className="bg-white rounded-md border border-[#E4E4E7] mb-6 xl:mb-4">
                <div className="px-4 py-3">
                    <div className="h-5 w-32 bg-[#F4F4F5] rounded animate-pulse" />
                </div>
            </div>
        );
    }
        ...
        <div className="bg-white rounded-md border border-[#E4E4E7] mb-6 xl:mb-4">
            ...
            {isExpanded && (
                <div className="px-4 pb-4">
                    {summary ? (
                        <div>
                            <MarkdownContent className="text-[#52525B]">
                                {summary}
                            </MarkdownContent>
                        ...
                        <div className="text-center py-4">
                            ...
                            <button
                                ...
                                onClick={handleGenerate}
                                disabled={loading || !hasEntries}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-[#7C3AED] hover:bg-[#6D28D9] rounded-md disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                            >
                                {loading ? (
                                    <>
                                        <svg
